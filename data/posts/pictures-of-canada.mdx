...
draft: false
coverImage: '/assets/images/canada/maple.jpg'
...
Features images served using `next/image` component. The locally stored images are located in a folder with the following path: `/assets/images/canada/[filename].jpg`
...
<div className="flex flex-wrap -mx-2 overflow-hidden xl:-mx-2">
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Maple" src="/assets/images/canada/maple.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Lake" src="/assets/images/canada/lake.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Mountains" src="/assets/images/canada/mountains.jpg" width={640} height={427} />
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Toronto" src="/assets/images/canada/toronto.jpg" width={640} height={427} />
  </div>
</div>
