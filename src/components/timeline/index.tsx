  ...
  return (
    <ul>
      {history.map((item, index) => (
        <li
          key={`timeline${index}`}
          className='list-none relative ml-2.5 !my-0 pl-5 border-l border-primary pb-6
        ...
        >
          <div className="font-sans leading-[15px] mb-4 pt-0.5">{item.date}</div>
          <div className="font-sans font-semibold">{item.role}</div>
